...
public class JavaRunnerFollower extends Thread implements LoggingServer{
    ...
    public void shutdown(){
       ...
       // System.out.println("shut down request received");
        ...
        try{
            ...
            workerSocket.connect(this.myAddress);
            //poison pill
            OutputStream outputStream = workerSocket.getOutputStream();
            byte[] eof = "\n$$$\n".getBytes();
            ByteBuffer buffer = ByteBuffer.allocate(eof.length);
            buffer.put(eof);
            ...
            e.printStackTrace();
            System.out.println("problem shutting down JR");
        }*/
    ...
    private void startListener(){
        try{
            ...
            Thread getRequests = new Thread(() -> {
                try{
                   ...
                   // System.out.println("closing serverSocket");
                    ...
                    System.out.println("problem JR get requests");
                    e.printStackTrace();
                }
            ...
            System.out.println("problem in startListener");
            e.printStackTrace();
        }
    }
