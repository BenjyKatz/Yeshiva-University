...
public class Benchmarks {
    ...
    @Benchmark
    public BufferedImage testParallel() throws Exception {
        var transformer = new ParallelTransformer(originalImage);
        return transformer.resizeAndAdjustBrightness(scaleFactor, 0.5);
    }
/*
    @Benchmark
    public BufferedImage testParallelRegions() throws Exception {
        var transformer = new ParallelTransformerRegions(originalImage);
        return transformer.resizeAndAdjustBrightness(scaleFactor, 0.5);
    }

    @Benchmark
    public BufferedImage testParallelCache() throws Exception {
        var transformer = new ParallelTransformerCache(originalImage);
        return transformer.resizeAndAdjustBrightness(scaleFactor, 0.5);
    }*/
}
