...
public class ParallelTransformerBrightenFirst implements ImageTransformer {

    private BufferedImage originalImage;

    public ParallelTransformerBrightenFirst(BufferedImage originalImage) {
    ...
    */
    ...
    public BufferedImage resizeAndAdjustBrightness(double scaleFactor, double brightnessFactor) {
        ...
        adjustBrightnessParallel(this.originalImage, brightnessFactor);
