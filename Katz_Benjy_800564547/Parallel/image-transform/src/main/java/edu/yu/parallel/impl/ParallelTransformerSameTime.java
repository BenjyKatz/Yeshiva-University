...
public class ParallelTransformerSameTime implements ImageTransformer {

    private BufferedImage originalImage;
    private double brightnessFactor;
    public ParallelTransformerSameTime(BufferedImage originalImage) {
            ...
            for (int i = 0; i < newHeight; i++) {
                ...
                futures.add(executor.submit(() -> {
                    for (int x = 0; x < newWidth; x++) {
                        Color originalColor = new Color(resizedImage.getRGB((int)(x/scaleFactor), (int)(currentY/scaleFactor)), true);
